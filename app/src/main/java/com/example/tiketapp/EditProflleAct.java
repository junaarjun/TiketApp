...
public class EditProflleAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_proflle);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Picasso.with(EditProflleAct.this)
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(photo_location != null) {
                    final StorageReference storageReference1 = storage.child(System
                            .currentTimeMillis() + "." + getFileExtension(photo_location));
                ...
                //berpindah activity
                Intent gobackprofile = new Intent(EditProflleAct.this, MyProfileAct.class);
