...
public class TicketAdapter extends RecyclerView.Adapter<TicketAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int i) {
        holder.xnama_wisata.setText(myTicket.get(i).getNama_wisata());
        holder.xlokasi.setText(myTicket.get(i).getLokasi());
        holder.xjumlah_tiket.setText(myTicket.get(i).getJumlah_tiket() + " Tickets");
